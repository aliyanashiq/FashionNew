...
function Footer() {
  return (
    <footer className="h-[30vh] w-[147%] bg-black text-white py-8 lg:mt-2rem md:mt-[5rem] md:w-[147%] lg:w-[100%] xl:w-[103%] xl:mt-[5rem] lg:mt-[9rem] mt-[5rem]">
      <div className="container  lg:mx-0 xl:flex lg:block  items-center lg:w-[100%] md:w-[150%] xl:justify-between lg:justify-center xl:ml-[20px] lg:ml-0 md:ml-[11.5rem] xl:mt-[3rem] lg:mt-[0rem]">
