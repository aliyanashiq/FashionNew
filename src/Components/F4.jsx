...
function F4() {
    ...
    return (
        <div className='w-[147%] xl:h-[284vh] lg:h-[330vh]  md:h-[367vh]  bg-white flex flex-col md:flex-row relative
        xl:px-16 xl:py-8 
        lg:px-8 lg:py-5
        xl:w-full lg:w-[100%] md:w-[147%] md:py-8 '>
            ...
            ">
                {imageData.map((item, index) => (
                    ...
                    xl:h-[92vh] xl:flex xl:flex-col lg:flex lg:flex-col lg:h-[106vh] md:h-[105vh] xl:w-[100%] lg:w-[100%] w-[98%] md:flex md:flex-row bg-white  xl:mt-0 lg:mt-0 md:mt-[8rem] mt-[3rem] 
                    xl:pl-0 lg:pl-0 md:pl-[2rem] pl-[1rem] ">
                        {/* Image Section */}
                        <div className="relative w-[97%] h-[96vh] xl:h-[89vh] lg:h-[100vh]  md:w-[100%] md:h-[100vh] shadow-lg ">
                            <img
                                src={item.imageUrl}
                                alt={item.heading}
                                className="h-[500px] xl:h-[33.8rem] lg:h-[520px] md:h-[100vh] 
                            ...
                            lg:absolute    lg:top-[0rem]    lg:left-[18.4rem]    lg:w-[50%]   lg:h-[100%]  lg:pl-2 lg:p-0 lg:pr-2
                             md:absolute md:top-[56rem] md:left-[80px] md:bg-white md:text-black md:h-[15rem] md:shadow-lg flex flex-col justify-center
