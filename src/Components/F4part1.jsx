...
function F4part1() {
  ...
  return (
    <div className='h-screen  flex-col items-center hidden  xl:flex lg:flex md:hidden'>
      <Select
      ...
      <div className="relative xl:h-[82.5vh] lg:h-[93vh] w-full max-w-xl group">
        ...
        {/* Overlay content */}
        <div className="absolute top-40 xl:left-14 lg:left-[2rem] inset-0 flex flex-col items-center justify-center bg-gray-800 bg-opacity-75 transition-opacity duration-300 group-hover:opacity-0 h-52 w-64 p-4">
